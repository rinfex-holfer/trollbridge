...
export const charConfig: {[key: string]: CharTemplate} = {
    [CharKey.FARMER]: {
        ...
        moralePrice: [5,15],
        dmg: [1, 2],
        // resources: {gold: [1, 5], food: [0, 1]},
        resources: {gold: [1, 5], food: [1, 1]},
        isCombatant: true,
        atlasKey: 'peasant',
        isDefender: false,
        isRanged: false,
    ...
    [CharKey.KNIGHT]: {
        ...
        block: 0.25,
        evade: 0.75,
        resources: {gold: [50, 100], food: [3, 6]},
        isCombatant: true,
        atlasKey: 'knight',
        isMounted: true,
    },
    [CharKey.VIGILANTE]: {
        ...
        block: 0.25,
        evade: 0.75,
        resources: {gold: [100, 200], food: [3, 6]},
        isCombatant: true,
        atlasKey: 'knight',
        isMounted: true,
    },
    [CharKey.KING]: {
        name: 'chars.final_boss',
        hp: 70,
        morale: 300,
        moralePrice: [100,200],
        dmg: [10, 15],
        ...
        block: 0.25,
        evade: 0.75,
        resources: {gold: [500, 600], food: [5, 6]},
        isCombatant: true,
        atlasKey: 'knight',
        isMounted: true,
    },
